                ...
                <div className="row">
                    ...
                    <div className="col-md-8 px-5">
                        ...
                        <div className="genres pb-4">
                            {Details.genres.map((value,index)=> <span key={index} className="p-2  mx-2 rounded">{value.name}</span>)}
                        </div>
                        <div className="vote pt-4">
                            <ul>
                                ...
                                <li>Release date : {Details.release_date} {Details.first_air_date} </li>
                            </ul>
                        </div>
